...
module.exports = {
    execute: function (interaction, ApiKey, ScriptID) { return __awaiter(void 0, void 0, void 0, function () {
        var Identifier, Request, Embed_1, Response, Embed;
    ...
    Data: new builders_1.SlashCommandBuilder()
        ...
        .addStringOption(function (option) { return option.setName("identifier").setRequired(true).setDescription("Identifier of the user to remove. Could be a HWID, IPv6, IPv4."); })
};
